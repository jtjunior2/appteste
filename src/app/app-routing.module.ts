...
import { DashboardComponent } from './dashboard/dashboard.component';  // Importe o DashboardComponent
...
const routes: Routes = [
  { path: '', component: DashboardComponent },  // Define o Dashboard como rota inicial
